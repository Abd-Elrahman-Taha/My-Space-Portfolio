...
const HeroContent = () => {
    return (
        <motion.div
            initial="hidden"
            animate="visible"
            className="relative flex md:flex-row flex-col-reverse items-center justify-center gap-10 md:gap-0 md:px-20 px-5 mt-40 w-full z-30"
        >
            {/* Left Content */}
            <div className="h-full w-full md:w-3/6 flex flex-col gap-5 justify-center text-start">
                ...
                >
                    <h1 className="text-4xl md:text-6xl font-extrabold leading-tight text-white max-w-[650px] flex flex-wrap items-baseline">
                        <span className="text-violet-400 text-2xl md:text-3xl font-medium tracking-wide mr-3">
                            Hi, I&apos;m
                        </span>
                    ...
                    <h2 className="text-lg md:text-xl font-bold text-violet-400/90 tracking-wide mt-1">
                        Front-End <span className="text-white">&amp;</span> 3D Web Developer
                    </h2>
